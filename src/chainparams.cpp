...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.funcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.funcointools.com");
        vSeeds.emplace_back("dnsseed.funcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.funcointools.com");
        vSeeds.emplace_back("seed-b.funcoin.loshan.co.uk");
