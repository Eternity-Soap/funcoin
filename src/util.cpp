...
const char * const BITCOIN_CONF_FILENAME = "funcoin.conf";
const char * const BITCOIN_PID_FILENAME = "funcoind.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Funcoin";
#else
    // Unix
