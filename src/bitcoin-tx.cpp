...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s funcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  funcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded funcoin transaction") + "\n" +
              "  funcoin-tx [options] -create [commands]   " + _("Create hex-encoded funcoin transaction") + "\n" +
              "\n";
