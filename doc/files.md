...
* funcoin.conf: contains configuration settings for funcoind or funcoin-qt
* funcoind.pid: stores the process id of funcoind while running
...
* debug.log: contains debug information and general logging generated by funcoind or funcoin-qt
