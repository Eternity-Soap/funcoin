...
"""Verify that starting funcoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start funcoin with -h for help text")
        ...
        self.log.info("Start funcoin with -version for version information")
